...
<head>
	...
	<meta name="description" content="Crea8link - Social Network Mobile App Template ( Bootstrap 5 + PWA )"/>
	<meta property="og:title" content="Crea8link - Social Network Mobile App Template ( Bootstrap 5 + PWA )" />
	<meta property="og:description" content="Crea8link - Social Network Mobile App Template ( Bootstrap 5 + PWA )" />
    ...
    <!-- Title -->
	<title>Crea8link - Social Network Mobile App Template ( Bootstrap 5 + PWA )</title>
...
<div class="page-wraper header-fixed">
		...
		<div class="container">
			<div class="main-bar">
				...
				<div class="right-content d-flex align-items-center">
					<a href="reels.php" class="bell-icon me-2">
					...
					<a href="notification.php" class="bell-icon me-2">
    ...
    <div class="sidebar">
		<div class="author-box">
			<div class="dz-media">
				<img src="<?= htmlspecialchars($profileImage) ?>" alt="author-image">
			</div>
			<div class="dz-info">
				<!-- <span>Good Morning</span> -->
				<h5 class="name"><?= htmlspecialchars($userName) ?></h5>
			</div>
		</div>
		<ul class="nav navbar-nav">	
			...
			<li><a class="nav-link" href="events.php">
				<span class="dz-icon">
			...
			<li><a class="nav-link" href="notification.php">
				<span class="dz-icon">
			...
			<li><a class="nav-link" href="chat.php">
				<span class="dz-icon">
			...
			<li><a class="nav-link" href="welcome.php">
				<span class="dz-icon">
		...
		<div class="sidebar-bottom">
			<h6 class="name">Crea8link - Social Network</h6>
						...
						<div class="swiper-container categorie-swiper">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<a href="story.php" class="categore-box style-1">
										<div class="story-bx">
								...
								<div class="swiper-slide">
									<a href="live-story.php" class="categore-box">
										<div class="story-bx">
								...
								<div class="swiper-slide">
									<a href="story.php" class="categore-box">
										<div class="story-bx">
                ...
                <div class="post-area">
					<div class="post-card">
						<div class="top-meta">
							<div class="d-flex justify-content-between align-items-start">
								<a href="user-profile.php" class="media media-40">
									<img class="rounded" src="assets/images/stories/small/pic4.jpg" alt="/">
								</a>
								<div class="meta-content ms-3">
									<h6 class="title mb-0"><a href="user-profile.php">Lucas Mokmana</a></h6>
									<ul class="meta-list">
										<li>
						...
						<div class="dz-media">
							...
							<div class="post-meta-btn">
								<ul>
									...
									<li>
										<a href="comment.php" class="action-btn bg-secondary">
					...
					<div class="post-card">
						<div class="top-meta">
							<div class="d-flex justify-content-between align-items-start">
								<a href="user-profile.php" class="media media-40">
									<img class="rounded" src="assets/images/stories/small/pic6.jpg" alt="/">
								</a>
								<div class="meta-content ms-3">
									<h6 class="title mb-0"><a href="user-profile.php">Hendri Lee</a></h6>
									<ul class="meta-list">
										<li>
											<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M12.25 5.83331C12.25 9.91665 7 13.4166 7 13.4166C7 13.4166 1.75 9.91665 1.75 5.83331C1.75 4.44093 2.30312 3.10557 3.28769 2.121C4.27226 1.13644 5.60761 0.583313 7 0.583313C8.39239 0.583313 9.72774 1.13644 10.7123 2.121C11.6969 3.10557 12.25 4.44093 12.25 5.83331Z" stroke="black" stroke-opacity="0.6" stroke-linecap="round" stroke-linejoin="round"/>
					...
					<div class="post-card">
						<div class="top-meta">
							<div class="d-flex justify-content-between align-items-start">
								<a href="user-profile.php" class="media media-40">
									<img class="rounded" src="assets/images/stories/small/pic2.jpg" alt="/">
								</a>
								<div class="meta-content ms-3">
									<h6 class="title mb-0"><a href="user-profile.php">Thomas Edison</a></h6>
									<ul class="meta-list">
										<li>
											<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M12.25 5.83331C12.25 9.91665 7 13.4166 7 13.4166C7 13.4166 1.75 9.91665 1.75 5.83331C1.75 4.44093 2.30312 3.10557 3.28769 2.121C4.27226 1.13644 5.60761 0.583313 7 0.583313C8.39239 0.583313 9.72774 1.13644 10.7123 2.121C11.6969 3.10557 12.25 4.44093 12.25 5.83331Z" stroke="black" stroke-opacity="0.6" stroke-linecap="round" stroke-linejoin="round"/>
	...
	<div class="menubar-area">
        <div class="toolbar-inner menubar-nav">
            ...
            <!-- Create Post -->
            <a href="create-post.php" class="nav-link add-post">
                <i class="fa-solid fa-plus"></i>
            </a>
        ...
        <div class="offcanvas-body container pb-0">
			...
			<div class="canvas-height mt-4 dz-scroll">
				<ul class="share-list">
					<li>
						<div class="left-content">
							<a href="user-profile.php"><img src="assets/images/stories/small/pic1.jpg" alt="/"></a>
					...
					<li>
						<div class="left-content">
							<a href="user-profile.php"><img src="assets/images/stories/small/pic2.jpg" alt="/"></a>
							<a href="user-profile.php">
					...
					<li>
						<div class="left-content">
							<a href="user-profile.php"><img src="assets/images/stories/small/pic3.jpg" alt="/"></a>
							<a href="user-profile.php">
					...
					<li>
						<div class="left-content">
							<a href="user-profile.php"><img src="assets/images/stories/small/pic4.jpg" alt="/"></a>
							<a href="user-profile.php">
					...
					<li>
						<div class="left-content">
							<a href="user-profile.php"><img src="assets/images/stories/small/pic5.jpg" alt="/"></a>
							<a href="user-profile.php">
					...
					<li>
						<div class="left-content">
							<a href="user-profile.php"><img src="assets/images/stories/small/pic6.jpg" alt="/"></a>
							<a href="user-profile.php">
					...
					<li>
						<div class="left-content">
							<a href="user-profile.php"><img src="assets/images/stories/small/pic7.jpg" alt="/"></a>
							<a href="user-profile.php">
					...
					<li>
						<div class="left-content">
							<a href="user-profile.php"><img src="assets/images/stories/small/pic8.jpg" alt="/"></a>
							<a href="user-profile.php">
