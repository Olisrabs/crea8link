	...
	<div class="loader-screen" id="splashscreen">
		<div class="main-screen">
			...
			<div class="brand-logo">
				<div class="logo">
					<img src="assets/images/vector.svg" alt="spoon-1" class="wow bounceInDown">
				</div>
	...
	<div class="content-body">
		<div class="container vh-100">
			<div class="welcome-area">
				<div class="bg-image bg-image-overlay" style="background-image: url(assets/images/login/pic1.jpg);"></div>
				<div class="join-area">
					<div class="mb-3">
						<div class="swiper-container get-started">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<div class="started">
										<h1 class="title">Hello, And Welcome to Soziety.</h1>
					...
					<a href="enter-email.php" class="btn btn-primary btn-block mb-3">CREATE ACCOUNT</a>
					<a href="login.php" class="btn btn-light btn-block mb-3">SIGN IN</a>
					<a href="forgot-password.php" class="text-light text-center d-block">Forgot your account?</a>
				</div>
			</div>
		</div>
	</div>
