        ...
        if ($result->num_rows === 1) {
            ...
            if (password_verify($password, $user['password'])) {
                ...
                if ($user['status'] !== 'Active') {
                    $showModal = true;
                    $modalType = 'error';
                    $modalTitle = 'Account Inactive';
                    $modalMessage = 'Your account is not active yet.';
                } else {
                    // ✅ Login success
                ...
                $modalMessage = 'Incorrect email/username or password.';
            }
        } else {
            $showModal = true;
            $modalType = 'error';
				...
				<div class="join-area">
					...
					<form method="post">
						<div class="mb-3 input-group input-group-icon">
							...
							<input type="text" name="identifier" class="form-control" required placeholder="Username or Email">
						</div>
						<div class="mb-3 input-group input-group-icon">
							<span class="input-group-text">
								<div class="input-icon">
							...
							<input type="password" name="password" class="form-control dz-password" required placeholder="Password">
					...
					<div class="d-flex align-items-center justify-content-center">
						...
						<a href="enter-email.php" class="btn-link d-block ms-3 text-underline">Signup here</a>
					</div>
				</div>
			</div>
		</div>
        ...
        <div class="modal-content text-center">
            <div class="modal-body py-4">
                ...
                <?php if ($modalType === 'success'): ?>
                    <svg width="32" height="32" viewBox="0 0 24 24" stroke="green" fill="none" stroke-width="2">
                        <polyline points="9 11 12 14 22 4"></polyline>
                        <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5"></path>
                    </svg>
                <?php else: ?>
                    <svg width="32" height="32" viewBox="0 0 24 24" stroke="red" fill="none" stroke-width="2">
                ...
                <h5 class="mt-3"><?= htmlspecialchars($modalTitle) ?></h5>
