		...
		<div class="container">
			<div class="main-bar">
				...
				<div class="right-content">
					<a href="setting.php" class="bell-icon">
            ...
            <div class="profile">
                <div class="main-profile">
					<div class="left-content">
						...
						<h5 class="mt-1"><?= htmlspecialchars($userName) ?></h5>
						<h6 class="text-primary font-w300"><?= htmlspecialchars($user['skills']) ?></h6>
					</div>
					<div class="right-content">
			...
			<div class="contant-section">
				<div class="social-bar">
					<ul>
						...
						<li>
							<a href="social-friends.php">
								<h4><?= htmlspecialchars($user['following_count']) ?></h4>	
								<span>Following</span>
							</a>
						</li>
						<li>
							<a href="social-friends.php">
								<h4><?= htmlspecialchars($user['followers_count']) ?></h4>	
								<span>Followers</span>
							</a>
						</li>
					</ul>
